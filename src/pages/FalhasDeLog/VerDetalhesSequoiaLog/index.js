...
export default function VerdetalhesFalhasSequoiaLog() {
  const [csv, setCsv] = useState(null);
  useEffect(() => {
    fetch("../../../arquivos/basefalhas_login.csv")
      .then((r) => r.text())
      .then((text) => {
  ...
  return (
    <>
      <Header />
      <div className="container-Ver-falhaslog">
